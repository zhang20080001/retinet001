...
parser.add_argument('--batch_size', dest='batch_size', type=int, default=4, help='number of samples in one batch')
...
def lowlight_train(lowlight_enhance):
    ...
    train_low_data_names = glob('/kaggle/input/lol-v3/lol_v3/our485/low/*.png') + glob('./data/syn/low/*.png')
    train_low_data_names.sort()
    train_high_data_names = glob('/kaggle/input/lol-v3/lol_v3/our485/high/*.png') + glob('./data/syn/high/*.png')
